...
public class ShoppingAppTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("--------------Set boolean variable true if 'ipad' exists in the items");
        ...
        if (iPadExists) {
            ...
            System.out.println("NO iPad in the list");
        }
        int firstIndexGloves = Arrays.toString(items).indexOf("Gloves");
        System.out.println("firstIndexGloves = " + firstIndexGloves);
